        ...
        <div class="box">
            <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <label for="telepon_perusahaan" class="col-lg-2 control-label">Telepon Perusahaan</label>
                        <div class="col-lg-6">
                            <input type="text" name="telepon_perusahaan" class="form-control" id="telepon_perusahaan" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="alamat_perusahaan" class="col-lg-2 control-label">Alamat Perusahaan</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="email_perusahaan" class="col-lg-2 control-label">Email Perusahaan</label>
                        <div class="col-lg-6">
                            <textarea name="email_perusahaan" class="form-control" id="email_perusahaan" rows="3" required></textarea>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    function showData() {
        $.get('{{ route('setting.show') }}')
            .done(response => {
                ...
                $('[name=telepon_perusahaan]').val(response.telepon_perusahaan);
                $('[name=alamat_perusahaan]').val(response.alamat_perusahaan);
                $('[name=email_perusahaan]').val(response.email_perusahaan);
            ...
            .fail(errors => {
                alert('Tidak dapat menampilkan data pengaturan');
                return;
            });
    }
</script>
